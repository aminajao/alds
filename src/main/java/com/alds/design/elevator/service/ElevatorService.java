...
public class ElevatorService {
	...
	public boolean pickUpRequest(int floorRequest) {
        int maxRequestPerElevator = activeRequests.get()/elevatorCount+1;
        ...
        for(Elevator elevator : elevators){
             ...
             */
            if(elevator.getStatus() == ElevatorStatus.REPAIR || elevator.getTotalFloorRequests() >= maxRequestPerElevator){
                continue;
            }
